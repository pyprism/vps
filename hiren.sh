...
apt-get install btop curl software-properties-common duf zsh ntp libffi-dev ncdu vnstat libpango1.0-0 youtube-dl letsencrypt finger htop python3-dev inxi axel fail2ban sendmail git nethogs unzip nmap imagemagick webp -y
...
apt update 
apt install -y postgresql-15 libpq-dev postgresql-contrib
