...
apt-get install vnstat youtube-dl finger htop docker.io axel fail2ban python-dev sendmail git python-software-properties software-properties-common python-pip nethogs unzip nmap -y
