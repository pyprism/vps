...
apt-get install zsh ntp libffi-dev vnstat libpango1.0-0 youtube-dl letsencrypt finger htop python3-dev inxi axel fail2ban python-dev sendmail git python-pip nethogs unzip nmap imagemagick webp -y
