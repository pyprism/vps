...
apt-get install zsh ntp libffi-dev vnstat libpango1.0-0 youtube-dl letsencrypt finger htop python3-dev inxi axel fail2ban python-dev sendmail git python-software-properties software-properties-common python-pip nethogs unzip nmap -y
